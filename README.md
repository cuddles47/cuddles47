...
Welcome to my little space on Github. Here i put my thoughts and ideas into code . <img alt="GIF" src=[wave.gif](https://github.com/cuddles47/cuddles47/blob/main/assets/wave.gif) width="60px" /> 

- 🔭 Primary Coding language : C++
- 🐍 Most used language : Python
- 🌱 Currently studying IoT and Machine Learning 
- 👯 I’m looking to collaborate with other programmers
- ✨ Fascinated by new technologies and want a place to learn n cook the code <img alt = "GIF" src=[gandalf_parrot.gif](https://github.com/cuddles47/cuddles47/blob/main/assets/gandalf_parrot.gif) width="20px" />
- 🥅 2023 Goals: Contribute more to ML projects, full fill my wallet for the fam <img alt = "GIF" src=[coin.gif](https://github.com/cuddles47/cuddles47/blob/main/assets/coin.gif) width="20px" />
